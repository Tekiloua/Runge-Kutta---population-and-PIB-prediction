...
export const Algorithme = () => {
  return (
    <div className="px-2 py-8 max-w-5xl space-y-2">
      ...
      <section className="space-y-4">
        ...
        <p className="text-gray-700 text-lg">
          ...
          <strong>Runge-Kutta</strong>, une méthode numérique très utilisée pour
      ...
      <div className="text-center pt-8">
        <p className="text-xl font-medium text-gray-800">
          Prêt à explorer le monde fascinant des équations différentielles ? 🚀
        </p>
      </div>
    </div>
  );
